...
// checks if the SocratesLibrary type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &SocratesLibrary{}
...
func NewNullableSocratesLibrary(val *SocratesLibrary) *NullableSocratesLibrary {
	return &NullableSocratesLibrary{value: val, isSet: true}
}
